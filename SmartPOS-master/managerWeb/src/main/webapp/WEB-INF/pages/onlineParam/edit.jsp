    ...
    <div class=" ModelDetail paddingBottom10">
        <div class="CurrentPosition marginBottom10">
            <span class="positionText">当前位置:</span><span class="positionText">设备参数维护</span><span
                class="positionText">></span><a href="#" class="positionText">设备参数编辑</a>
        </div>
        <div class="fromInputBtn">
            <div class="seachEquip marginTop10">
                <form id="updateForm" name="updateForm" action="update.do" method="post">
                    <input type="hidden" value="${model.onlineParamId}" name="onlineParamId" id="onlineParamId">
                    ...
                    <table class="threeBtn tanTable">
                        <tr>
                            ...
                            <td>
                                <div class="Pos_rela">
                                    <input type="text" class="seachIptText marginRight10 borderRadius" name="paramName"
                                           onclick="cleanError()"
                                           maxlength="32"
                                           id="paramName" value="${model.paramName}"/>
                            ...
                            <td>
                                <div class="Pos_rela">
                                    <input type="text" class="seachIptText marginRight10 borderRadius" name="paramDesc"
                                           onclick="cleanError()"
                                           maxlength="127"
                                           id="paramDesc" value="${model.paramDesc}"/>
                            ...
                            <td colspan="3">
                                <div class="Pos_rela">
                                    <input type="text" class="seachIptText marginRight10 borderRadius" maxlength="127"
                                           onclick="cleanError()"
                                           name="paramValue" id="paramValue" value="${model.paramValue}"/>
...
<script type="text/javascript">
    ...
    function ajaxValidateParamNameUpdate() {
        var paramNameVal = $.trim(paramName.val());
        var onlineParamId = $("#onlineParamId").val();
        $.ajax({
            url: "ajaxValidateParamNameUpdate.do",
            async: true,
            type: "post",
            data: {
                paramName: paramNameVal,
                onlineParamId: onlineParamId
            },
            dataType: "text",
            cache: false
        }).done(function (data) {
