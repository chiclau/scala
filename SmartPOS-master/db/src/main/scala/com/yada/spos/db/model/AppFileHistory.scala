...
/**
  ...
  * 应用上传历史
  */
@Entity(name = "T_APP_FILE_HISTORY")
class AppFileHistory {

  /**
    * 主键id
    */
  @Id
  @GeneratedValue(generator = "APP_FILE_HISTORY_SEQ")
  @SequenceGenerator(name = "APP_FILE_HISTORY_SEQ", sequenceName = "SEQ_T_APP_FILE_HISTORY", allocationSize = 1)
  @Column(name = "APP_FILE_ID", columnDefinition = "NUMBER(16)", nullable = false)
  @BeanProperty
