...
/**
  ...
  * 固件上传历史
  */
@Entity(name = "T_OTA_FILE_HISTORY")
class OtaHistory {
  /**
    * 主键id
    */
  @Id
  @GeneratedValue(generator = "OTA_HISTORY_SEQ")
  @SequenceGenerator(name = "OTA_HISTORY_SEQ", sequenceName = "SEQ_T_OTA_HISTORY", allocationSize = 1)
