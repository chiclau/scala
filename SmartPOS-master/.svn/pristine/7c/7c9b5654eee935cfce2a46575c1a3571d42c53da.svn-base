    ...
    <div class="ModelDetail paddingBottom10">
        ...
        <div class="CurrentPosition marginBottom10">
            <span class="positionText">当前位置:</span><a href="#" class="positionText">应用分组:</a><a href="#"
                                                                                                class="positionText">关联设备</a>
        </div>
        <div class="fromInputBtn">
            <div class="seachEquip marginTop10">
                <form action="associatedDevList.do" method="get">
                            ...
                            <td>
                                <div class="Pos_rela">
                                    <input type="text" class="seachIptText marginRight10 borderRadius"
                                           ...
                                           value="${associatedVAppGroupDeviceQuery.firmCode}" maxlength="4"/>
                            ...
                            <td>
                                <div class="Pos_rela">
                                    <input type="text" class="seachIptText marginRight10 borderRadius"
                                           ...
                                           value="${associatedVAppGroupDeviceQuery.prodCode}" maxlength="12"/>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="Pos_rela">
                                    <input type="text" class="seachIptText marginRight10 borderRadius"
                                           onclick="cleanError()"
                                           name="merNo" value="${associatedVAppGroupDeviceQuery.merNo}"
                                           maxlength="15"/>
                            ...
                            <td>
                                <div class="Pos_rela">
                                    <input type="text" class="seachIptText marginRight10 borderRadius"
                                           onclick="cleanError()"
                                           name="termNo" value="${associatedVAppGroupDeviceQuery.termNo}"
                                           maxlength="8"/>
...
<script type="text/javascript">
    ...
    function allSelect() {
        if (!flag) {
            ...
            window.location = "allAssociateDev.do?firmCodeAndDevSns=" + firmCodeAndDevSn + "&appGroupId=${appGroupId}";
