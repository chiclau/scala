...
import com.yada.spos.common.{DatabaseEncrypt, HsmComponent, SignValidate}
...
/**
  ...
  */
@Component
@ComponentScan(Array("com.yada.spos.heart"))
...
class SpringConfig {
  ...
  @Bean(name = Array("signValidate"))
  def signValidate(): SignValidate = {
    new SignValidate(new HsmComponent)
  }

  @Bean
  def restServerBySpring() = new RESTServerBySpring(List(classOf[RootRS]))
}

object SpringAplicationContext extends AnnotationConfigApplicationContext(classOf[SpringConfig]) {
}
