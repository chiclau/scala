...
object AppUpdateResultClientTest extends App {
  ...
  val target = client.target("http://127.0.0.1:60102/frontRS/v1/firms/JFMT/devices/SN999999999999999/updateResults/updateResult")
  val response = target.request()
    ...
    .post(Entity.json(Map("updateType" -> "1", "type" -> "1", "pkgName" -> "ss", "startTime" -> "222", "endTime" -> "222", "result" -> "1", "desc" -> "2").asJava))
